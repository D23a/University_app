...
,p_group_id=>wwv_flow_imp.id(29794241471015996630)
,p_step_template=>wwv_flow_imp.id(29793491732940994532)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(29794246547066996634)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(29794246900209996634)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-CardsRegion--styleB'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(29793534710619994552)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(29794247468344996635)
,p_region_id=>wwv_flow_imp.id(29794246900209996634)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(29794247936344996636)
...
,p_list_id=>wwv_flow_imp.id(29794245598867996633)
